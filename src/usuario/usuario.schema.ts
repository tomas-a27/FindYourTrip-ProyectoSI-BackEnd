...
export const solicitudConductorSchema = z.object({
  nroLicenciaConductorUsuario: z
    .string()
    .min(5, 'El n° de licencia no es válido'),
  vigenciaLicenciaConductorUsuario: z.coerce
    .date()
    .refine((date) => !isNaN(date.getTime()), {
      message:
        'La fecha de vencimiento es obligatoria o el formato es inválido',
    }),
