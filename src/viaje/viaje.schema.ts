...
export const viajeSchema = z.object({
  ...
  viajeHorario: z.string().regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, "Formato de hora inválido (HH:mm)"),
  viajeCantLugares: z.coerce.number().int().min(1, "Debe haber al menos 1 lugar"),
